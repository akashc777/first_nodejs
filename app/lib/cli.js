...
cli.responders.help = function () {
  const commands = {
    ...
    'list checks --up  --down': 'show a list of all the active checks in the system including their state. The "--up" and "--down" flags are both optional optional',
  ...
  // End with another horizaontal line
  cli.horizontalLine();
};
...
cli.centered = function (str) {
  ...
  // Calculate the left padding ther shoud be
...
cli.processInput = function (str) {
  ...
  if (str) {
    ...
    // Go through the possible inputs, emmit an event when a match is found
